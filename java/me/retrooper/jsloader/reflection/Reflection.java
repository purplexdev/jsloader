package me.retrooper.jsloader.reflection;
...
public final class Reflection {
    ...
    public static MethodInvoker getTypedMethod(Class<?> clazz, String methodName, Class<?> returnType, Class<?>... params) {
        ...
        throw new IllegalStateException(
                String.format("Unable to find method %s (%s).", new Object[] { methodName, Arrays.asList(params) }));
    }
    ...
    public static ConstructorInvoker getConstructor(Class<?> clazz, Class<?>... params) {
        ...
        throw new IllegalStateException(
                String.format("Unable to find constructor for %s (%s).", new Object[] { clazz, Arrays.asList(params) }));
    }
